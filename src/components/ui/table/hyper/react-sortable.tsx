...
// import { CSS } from '@octanejs/dnd-kit/utilities'

import { cn } from '@/lib/utils'
import { composeEventHandlers, useComposedRefs } from './composition'
...
function renderLocalSlot(
  ...
  return React.createElement(fallback, { ...slotProps, ref: props.ref, className, style }, children)
}
...
function SortableContent({
  ...
  const localSlot = withoutSlot ? children : renderLocalSlot(asChild, 'div', { ...options })

  return (
    <SortableContentContext.Provider value={true}>
      <SortableContext items={context.items} strategy={strategyProp ?? context.strategy}>
        <div ref={ref}>{localSlot}</div>
      </SortableContext>
...
function SortableItem({ ref, value, style, asHandle, asChild, disabled, className, ...itemProps }: SortableItemProps) {
...
function SortableItemHandle({ ref, asChild, disabled, className, ...itemHandleProps }: SortableItemHandleProps) {
